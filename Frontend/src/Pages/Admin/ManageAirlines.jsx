...
export default function ManageAirlines() {
  ...
  // Filter airlines by search term (name or country)
      ...
      <div className="admin-body d-flex">
        ...
        <main className="admin-main flex-grow-1 px-4 pt-4">
          ...
          <div className="main-content container-fluid mt-5 pt-3 px-4">
            <h1 className="fw-bold mb-4">Manage Airlines</h1>
            ...
            {/* Pagination */}
            {totalPages > 1 && (
              <Pagination className="justify-content-center mt-3 flex-wrap gap-1">
